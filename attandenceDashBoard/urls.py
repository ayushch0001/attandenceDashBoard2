...
from .views import register,logout_view, login_view,createSuperUser,register_faces,getData,lateDataView ,success,markAttandence,attendance_list ,export_attendance_to_excel,gethistorydata,export_month_attendance_to_excel,leaveManagement,employee_list,failedAttem_list
...
urlpatterns = [
    ...
    path('logout/',logout_view, name = 'logout'),
     ...
     path('failedAttem/', failedAttem_list, name='failedAttem_list'),
    path('leaveManagement/', leaveManagement, name='leavepage'),
