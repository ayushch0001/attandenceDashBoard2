...
class Department(models.Model):
    ...
    intime = models.TimeField(default=datetime.time(10, 0))  
    outTIme = models.TimeField(default=datetime.time(18, 0))
    workingHour = models.IntegerField(default=8)
    allowedHalfDay = models.IntegerField(default=0)
    earlyRelifeMinutes = models.IntegerField(default=15)
    earlyRelifeDays = models.IntegerField(default=2)
    allowedLeave = models.IntegerField(default=2)
...
class EmployeeRegistration(models.Model):
    ...
    sonOf =  models.CharField(max_length=100,blank=False,null=False)
    ...
    refrerName =  models.CharField(max_length=100,blank=False,null=False)
    referMob =  models.IntegerField(max_length=10,blank=False,null=False)
    pAddress =  models.CharField(max_length=1000,blank=False,null=False)
    pcity =  models.CharField(max_length=100,blank=False,null=False)
    pState = models.CharField(max_length=100,blank=False,null=False)
    cAddress =  models.CharField(max_length=100,blank=False,null=False)
    ccity =  models.CharField(max_length=100,blank=False,null=False)
...
class Failedattandence(models.Model):
    emp = models.ForeignKey(EmployeeRegistration, on_delete=models.CASCADE)
    date = models.DateField(default=None)
    singInTimeA = models.TimeField(default=None,null=True)
    siginImageA = models.ImageField(upload_to='static/signinFailed/',default=None)
...
class SalaryOfEveryPerson(models.Model):
    emp = models.ForeignKey(EmployeeRegistration,on_delete=models.CASCADE,default=None)
    salaryPerMonth = models.FloatField(default=0)

    def __str__(self) -> str:
        return f"{self.emp} - {self.salaryPerMonth}"

class employeeRecordEveryMonth(models.Model):
    employee = models.ForeignKey(EmployeeRegistration,on_delete= models.CASCADE,default= None)
    ...
    def __str__(self) -> str:
        return f"{self.employee} -  {self.monthDate.month}"